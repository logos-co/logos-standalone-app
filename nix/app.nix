{ pkgs, src, logosSdk, logosProtocolPkg, logosQtHost, logosLiblogos, logosDesignSystem, logosViewModuleRuntime, logosQtMcp ? null, capabilityModuleLgx, enableInspector ? (logosQtMcp != null) }:
